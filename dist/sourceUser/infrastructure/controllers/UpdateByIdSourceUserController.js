...
exports.UpdateByIdSourceUserController = void 0;
class UpdateByIdSourceUserController {
    constructor(updateByIdSourceUserUseCase) {
        this.updateByIdSourceUserUseCase = updateByIdSourceUserUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = parseInt(req.params.idSourceUser);
            const newSourceUser = req.body; // Supongamos que los datos a actualizar se envían en el body de la solicitud
            try {
                const updatedSourceUser = yield this.updateByIdSourceUserUseCase.run(id, newSourceUser);
...
exports.UpdateByIdSourceUserController = UpdateByIdSourceUserController;
